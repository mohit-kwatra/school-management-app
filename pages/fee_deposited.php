...
<head>
    ...
    <title>Student(s) With No Dues</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-light">
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div class="row justify-content-center" style="max-width: 100%;">
            <div class="col-10">
                <h4 class="text-center text-secondary my-3" style="text-decoration: underline;">Student(s) With No Dues</h4>
...
<?php  
    ...
    $query = "SELECT * FROM `students` INNER JOIN `fee_status` ON `students`.`roll_no` = `fee_status`.`student_roll_no` WHERE `fee_status`.`status` = 'Paid';";
