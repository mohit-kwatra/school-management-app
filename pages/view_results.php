...
<?php
                ...
                $query = "SELECT * FROM `marks` INNER JOIN `students` ON `marks`.`student_roll_no` = `students`.`roll_no`;";
...
?>
        <div class="row justify-content-center">
            <div class="col-10 col-md-8 border border-3" style="padding: 25px 30px;margin: 10px 0;">
