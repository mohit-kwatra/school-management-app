<?php
    ...
    if( $_SERVER['REQUEST_METHOD'] === "POST" )
    {
        if( isset( $_POST['submit'] ) )
        {
            ...
            $query = "INSERT INTO `teachers` (`id`,`fname`,`lname`,`father_name`,`email`,`dob`,`gender`,`category`,`mobile`,`subjects`,`status`,`address`) VALUES ('$id','$fname','$lname','$father_name','$email','$dob','$gender','$category','$mobile','$subjects','$status','$address');";
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div style="max-width: 100%;" class="row justify-content-center">
            <form method="POST" class="col-10">
                <h4 style="text-decoration: underline;" class="text-center text-secondary my-4">Teacher Registration Form</h4>
                ...
                <div class="row justify-content-center gap-2 border-top border-bottom py-3">
                    ...
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="text" name="subjects" id="subjects" class="form-control" placeholder="Subject Names" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                ...
                <div class="row gap-2 justify-content-center border-bottom py-3">
                    <div class="col-12 col-lg-7">
                        ...
                        <textarea name="address" id="address" rows="4" class="form-control" placeholder="Teacher's Address" autocomplete="off" required></textarea>
                    </div>
                    <div class="col-12 col-md-6 col-lg">
                        <label for="teacherId" class="form-label"><span class="redMark">*</span> Teacher ID</label>
                        <input type="number" name="teacherId" id="teacherId" class="form-control" placeholder="Assign Teacher ID" autocomplete="off" required>
                    </div>
