    ...
    <div class="container-fluid" style="padding: 0;">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="./certificate.php" class="nav-link active">Generate Certificate</a>
                        </li>
                        <li class="nav-item dropdown">
        ...
        <div class="row justify-content-center" style="max-width: 100%">
            <div class="col-8 py-3">
                <h4 class="text-center text-secondary py-3" style="text-decoration: underline;">Generate Certificate for a Student</h4>
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form action="view_certificate.php" method="POST" class="input-group border-top border-bottom py-3">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary input-group-text">Generate</button>
                        </form>
                    </div>
                </div>
            </div>
