    ...
    if( $_SERVER['REQUEST_METHOD'] === "POST" )
    {
        if( isset( $_POST['submit'] ) )
        {
            ...
            if( $_POST['submit'] === "search" )
            {
                ...
                {
                    echo "<script>alert('missing or invalid teacher ID !')</script>";
...
<body class="bg-light">
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div style="max-width: 100%;" class="row justify-content-center">
            <div class="col-10">
                <h4 style="text-decoration: underline;" class="text-center text-secondary my-4">Search Teacher</h4>
                ...
                <div class="row gap-2 justify-content-center border-top py-3">
                    ...
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="email" name="email" id="email" class="form-control" placeholder="Email Address" autocomplete="off" value="<?php if(isset($arr)) { echo $arr['email']; } ?>" disabled required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                ...
                <div class="row justify-content-center gap-2 border-top border-bottom py-3">
                    ...
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="text" name="subjects" id="subjects" class="form-control" disabled  placeholder="Subject Names" value="<?php if(isset($arr)) { echo $arr['subjects']; } ?>" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                ...
                <div class="row gap-2 justify-content-center border-bottom py-3">
                    <div class="col-12 col-lg-7">
                        ...
                        <textarea name="address" id="address" rows="4" class="form-control" placeholder="Teacher's Address" disabled autocomplete="off" required><?php if(isset($arr)) { echo $arr['address']; } ?></textarea>
                    </div>
                    <div class="col-12 col-md-6 col-lg">
                        <label for="teacherId" class="form-label">Teacher's ID</label>
                        <input type="number" name="teacherId" id="teacherId" class="form-control" value="<?php if(isset($arr)) { echo $arr['id']; } ?>" placeholder="Teacher's ID" autocomplete="off" disabled required>
                    </div>
                </div>
            </form>
        </div>
