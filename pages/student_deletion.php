    ...
    if( $_SERVER['REQUEST_METHOD'] === "POST" )
    {
        if( isset( $_POST['submit'] ) )
        {
            ...
            elseif( $_POST['submit'] === "delete" )
            {
                ...
                {
                    $query = "DELETE FROM `students` WHERE `roll_no` = '$roll_number';";
...
<body class="bg-light">
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div style="max-width: 100%;" class="row justify-content-center">
            <div class="col-10">
                <h4 style="text-decoration: underline;" class="text-center text-secondary my-4">Student Deletion Form</h4>
                ...
                <div class="row gap-2 justify-content-center border-top py-3">
                    ...
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="text" name="motherName" disabled id="motherName" class="form-control" placeholder="Mother's Name" autocomplete="off" value="<?php if(isset($arr)) { echo $arr['mother_name']; } ?>" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                ...
                <div class="row gap-2 justify-content-center border-bottom py-3">
                    <div class="col-12 col-lg-7">
                        ...
                        <textarea name="address" id="address" rows="4" class="form-control" disabled placeholder="Student's Address" autocomplete="off" required><?php if(isset($arr)) { echo $arr['address']; } ?></textarea>
                    </div>
