        ...
        if( isset( $_POST['submit'] ) )
        {
            ...
            elseif( $_POST['submit'] === "update" )
            {
                ...
                if(!empty($roll_number))
                {
                    ...
                    $query = "UPDATE `students` SET `fname` = '$fname',`lname` = '$lname',`father_name` = '$father_name',`mother_name` = '$mother_name',`dob` = '$dob',`gender` = '$gender',`category` = '$category',`mobile` = '$mobile',`grade` = '$grade',`status` = '$status',`address` = '$address' WHERE `roll_no` = '$roll_number';";
...
<head>
    ...
    <title>Student Information Updation</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-light">
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div style="max-width: 100%;" class="row justify-content-center">
            <div class="col-10">
                <h4 style="text-decoration: underline;" class="text-center text-secondary my-4">Student Information Updation Form</h4>
                ...
                <div class="row gap-2 justify-content-center border-top py-3">
                    ...
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="text" name="motherName" id="motherName" class="form-control" placeholder="Mother's Name" autocomplete="off" value="<?php if(isset($arr)) { echo $arr['mother_name']; } ?>" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                ...
                <div class="row gap-2 justify-content-center border-bottom py-3">
                    <div class="col-12 col-lg-7">
                        ...
                        <textarea name="address" id="address" rows="4" class="form-control" placeholder="Student's Address" autocomplete="off" required><?php if(isset($arr)) { echo $arr['address']; } ?></textarea>
                    </div>
                    <div class="col-12 col-md-6 col-lg">
                        <label for="rollNo" class="form-label"><span class="redMark">*</span> Roll No.</label>
                        <input type="text" name="rollNo" id="rollNo" class="form-control" value="<?php if(isset($arr)) { echo $arr['roll_no']; } ?>" placeholder="Student's Roll No." autocomplete="off" readonly required>
                    </div>
