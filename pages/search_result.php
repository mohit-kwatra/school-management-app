...
<head>
    ...
    <title>Student's Result Search</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div class="row justify-content-center" style="max-width: 100%">
            <div class="col-8 py-3">
                <h4 class="text-center text-secondary py-3" style="text-decoration: underline;">Search Result of a Student</h4>
                <div class="row justify-content-center">
                    <div class="col-md-6">
                        <form action="view_result.php" method="POST" class="input-group border-top border-bottom py-3">
                            ...
                            <button type="submit" name="submit" class="btn btn-primary input-group-text">Search</button>
                        </form>
                    </div>
                </div>
            </div>
