    ...
    if( $_SERVER['REQUEST_METHOD'] === "POST" )
    {
        if( isset( $_POST['submit'] ) )
        {
            ...
            if( $_POST['submit'] === "search" )
            {
                ...
                {
                    echo "missing or invalid roll no!";
            ...
            elseif( $_POST['submit'] === "update" )
            {
                ...
                if(!empty($teacher_id))
                {
                    ...
                    $query = "UPDATE `teachers` SET `fname` = '$fname',`lname` = '$lname',`father_name` = '$father_name',`email` = '$email',`dob` = '$dob',`gender` = '$gender',`category` = '$category',`mobile` = '$mobile',`subjects` = '$subjects',`status` = '$status',`address` = '$address' WHERE `id` = '$teacher_id';";
...
<head>
    ...
    <title>Teacher Information Updation</title>
    <!-- Bootstrap CSS -->
...
<body class="bg-light">
    ...
    <div class="container-fluid" style="padding: 0;">
        ...
        <div style="max-width: 100%;" class="row justify-content-center">
            <div class="col-10">
                <h4 style="text-decoration: underline;" class="text-center text-secondary my-4">Teacher Information Updation Form</h4>
                ...
                <div class="row gap-2 justify-content-center border-top py-3">
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="text" name="firstName" id="firstName" class="form-control" placeholder="First Name" value="<?php if(isset($arr)) { echo $arr['fname']; } ?>" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                        <label for="lastName" class="form-label"><span class="redMark">*</span> Last Name</label>
                        <input type="text" name="lastName" id="lastName" class="form-control" placeholder="Last Name" value="<?php if(isset($arr)) { echo $arr['lname']; } ?>" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                        <label for="fatherName" class="form-label"><span class="redMark">*</span> Father's Name</label>
                        <input type="text" name="fatherName" id="fatherName" class="form-control" placeholder="Father's Name" autocomplete="off" value="<?php if(isset($arr)) { echo $arr['father_name']; } ?>" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                        <label for="email" class="form-label"><span class="redMark">*</span> Email ID</label>
                        <input type="email" name="email" id="email" class="form-control" placeholder="Email Address" value="<?php if(isset($arr)) { echo $arr['email']; } ?>" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                        <label for="dob" class="form-label"><span class="redMark">*</span> Date of Birth</label>
                        <input type="date" name="dob" id="dob" class="form-control" placeholder="Date of Birth" value="<?php if(isset($arr)) { echo $arr['dob']; } ?>" autocomplete="off" required>
                    </div>
                </div>
                <div class="row justify-content-center gap-2 border-top border-bottom py-3">
                    ...
                    <div class="col-12 col-md-5 col-lg-2">
                        ...
                        <input type="text" name="mobile" id="mobile" class="form-control" placeholder="Mobile Number" value="<?php if(isset($arr)) { echo $arr['mobile']; } ?>" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                        <label for="subjects" class="form-label"><span class="redMark">*</span> Subject(s)</label>
                        <input type="text" name="subjects" id="subjects" class="form-control" value="<?php if(isset($arr)) { echo $arr['subjects']; } ?>" placeholder="Subject Names" autocomplete="off" required>
                    </div>
                    <div class="col-12 col-md-5 col-lg-2">
                        <label for="status" class="form-label"><span class="redMark">*</span> Status</label>
                        <select name="status" value="<?php if(isset($arr)) { echo $arr['status']; } ?>" id="status" class="form-select">
                            <option selected disabled>-Select-</option>
                ...
                <div class="row gap-2 justify-content-center border-bottom py-3">
                    <div class="col-12 col-lg-7">
                        ...
                        <textarea name="address" id="address" rows="4" class="form-control" placeholder="Teacher's Address" autocomplete="off" required><?php if(isset($arr)) { echo $arr['address']; } ?></textarea>
                    </div>
                    <div class="col-12 col-md-6 col-lg">
                        <label for="teacherId" class="form-label"><span class="redMark">*</span> Teacher ID</label>
                    ...
                    <div class="col-12 col-md-4 col-lg-2 align-self-center">
                        <button type="submit" name="submit" value="update" class="btn btn-primary <?php if(!isset($arr)) { echo "disabled"; } ?>">Update</button>
                    </div>
                </div>
            </form>
        </div>
